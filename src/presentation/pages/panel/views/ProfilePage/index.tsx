      ...
      <Card className="w-96 max-w-full flex flex-col p-10 gap-4">
        <div className="inline-block mx-auto relative">
          <div className="w-32 h-32 rounded-full overflow-hidden">
            <img src={userData && userData.userData.avatarUrl ? `${userData.userData.avatarUrl}` : "https://picsum.photos/200"} alt="profile" />
          </div>
        </div>
        ...
        <div className="flex flex-col bg-gray-50 border border-gray-200 rounded-lg py-2 px-3">
          <p className="text-gray-500 text-xs">Rol</p>
          <p className="text-gray-800">
            {role ? useRoleName({ roleNumber: role }) : "Rol desconocido"}
          </p>
        </div>
